<template>
  <div>
    <img style="width: 100%;height: 300px" src="./../../../../static/assets/backgroundImg/10.jpg"/>
    <div class="body">
      ...
      <el-carousel height="400px">
        <el-carousel-item v-for="item in 3" :key="item">
          <div class="product_image">
            <img v-for="index in 6" width="30%;" height="200px" style="color: blue;" :src="getHonourImg(item,index)">
          </div>
        </el-carousel-item>
      </el-carousel>
    </div>
...
<script>
  export default {
    ...
    methods:{
      getHonourImg(item,index){
        return `./../../../../static/assets/product/${index*item}.jpg`
      }
    },
  }
</script>
